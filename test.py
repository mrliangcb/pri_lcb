...
source=r'项目目的：为达到从商务文本中自动挖掘出关键价值信息，本项目需要展开文本数据采集和预处理工作，对商务文本进行分词、特征表示和特征提取；为提'
target=r'项目目的：为达到从商务文本中自动挖掘出关键价值信息，本项目需要展开文本数据采集和预处理工作，对商务文本进行分词、特征表示和特征提取；为提高文本数据挖掘的效率，本项目还将展开基于'
